...
template <class Tdata> void deleteList(Stack<Tdata> *stack);

template <class Tdata> Tdata findMin(Stack<Tdata> stack) {
...
template <class Tdata> void norm(Stack<Tdata> *stack) {
...
template <class Tdata> void show(Stack<Tdata> stack) {
  while (!stack.Empty()) {
    cout << "--------" << endl
         << stack.showData() << endl
         << "--------" << endl;
